...
void main() {
  group('Interval Routine Multiple Completions Tests', () {
    ...
    test('Interval routine allows multiple completion rows in the same day', () async {
      const routineId = 'r_interval_test';
      const dateStr = '2026-08-04';

      await db.insert('routines', {'id': routineId, 'title': 'Interval Routine'});
      await db.insert('routine_schedules', {'id': 'sched_1', 'routineId': routineId, 'intervalHours': 4});
